...
| KYC | Customer status and review workflow | KYC case record, vendor response archive |
| AML | Risk scoring and case management | AML case, decision log, STR workflow evidence |
